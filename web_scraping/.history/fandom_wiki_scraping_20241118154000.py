...
def fetch_characters(url, category):
    ...
    for character in characters:
        ...
        character_data = {
            ...
            "character_link": "https://harrypotter.fandom.com/wiki/Character_Names" + character.get('href'),
            "category": category
        }
...
canon_characters_url = "https://harrypotter.fandom.com/wiki/Character_Name"
