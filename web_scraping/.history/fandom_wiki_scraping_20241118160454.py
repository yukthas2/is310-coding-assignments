...
def fetch_characters(url):
    ...
    for character in characters:
        ...
        link = "https://harrypotter.fandom.com/wiki/Category:Individuals_by_year_of_birth" + character.get('href')
        character_data.append([name, link])

    return character_data

# URL of the page to scrape
url = "https://harrypotter.fandom.com/wiki/Category:Individuals_by_year_of_birth"
